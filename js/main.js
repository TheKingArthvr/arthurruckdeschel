...
const arthurTexture = new THREE.TextureLoader().load('../pictures/arthur.jpg');
...
const normalTexture = new THREE.TextureLoader().load('../pictures/normal.jpg');
...
function moveCamera() {
  ...
  arthur.rotation.y += 0.01;
  arthur.rotation.z += 0.01;
